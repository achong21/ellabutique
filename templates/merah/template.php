  ...
  <meta http-equiv="Copyright" content="Andy prabowo" "Andyprabowo22@yahoo.com">
  <meta name="author" content="Andy Prabowo" "http://griyagaya.co.cc">
  ...
  <!--// SHORTCUT //-->
  <link rel="shortcut icon" href="gg_m.png" />
  ...
  <span class="style3">&nbsp;&nbsp;<span class="style4">I&nbsp;</span>&nbsp;</span>
  ...
  <input style='width: 50px; height: 27px;' type="submit" value="CEK"  class= "button" name="submittracking" id="trksubmit"/>
  </form>
  </div></div>
  <!--========= Cek Pengiriman Barang  ========================-->			
  ...
  <div align="center"><a href="testimoni.html" class="button" input style='width: 80px; height: 10px;'>
  ...
  <p>Copyright © 2018. Depeloved by: <a href="mailto:andyprabowo22@yahoo.com?subject=Order Web">Andy Prabowo</p>

  <ul class="network"><li>
  <script language="javascript">
  document.write("<a href='http://twitter.com/home/?status=" + document.URL + "' target='_blank'><img src='<?php echo "$f[folder]/images/twitter_icon.gif" ?>' border='0'/></a> &nbsp; <a href='https://www.facebook.com/andi.slalusetia'><img src='<?php echo "$f[folder]/images/facebook_icon.gif" ?>' border='0'/></a>");
  </script></li>
  	   <!--========= Sound Flash========================-->			
		<li>
		<object
