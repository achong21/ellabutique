...
// PRODUK DISKON
 ...
 //=======================================================================================================
  ...
  <tr><td colspan=2><br /><a href=javascript:history.go(-1)><input style='width: 230px; height: 30px;' type=submit 
  class= button value='LANJUTKAN BELANJA'></a><br /></td>
        
  <td colspan=4 align=right><br /><a href=selesai-belanja.html><input style='width: 200px; height: 30px;' type=button 
  ...
  <small><a href='https://www.google.com/maps/place/PD.+Rizky+Jaya/@-6.2499264,106.9807119,20z/data=!4m5!3m4!1s0x2e698c4a5aec2db9:0x8a1a714cab1f27cc!8m2!3d-6.2499264!4d106.9809855' style='color:#990000;font-size:12px; text-align:left'>
[lihat maps]</a></small><br/><br/><br/><br/>";}
 ...
 //=======================================================================================================
  ...
  <tr><td>&nbsp;</td><td><span class=isikomen>(masukkan 6 kode di atas)<br />
  <input type=text class='isikoment2' name=kode size=10 maxlength=6><br /></td></tr>
  </td><td colspan=2><p style='padding-top:15px ;'><input style='width: 200px; height: 30px;' type=submit
 ...
 //=======================================================================================================
  ...
  echo "<h4 class='heading colr'>Data Pembeli</h4>
	  ...
	  <input type=text class='isikoment2' name=kode size=10 maxlength=6><br /></td></tr>
      <tr><td colspan=2><input style='width: 120px; height: 30px;' type=submit class= button value=PROSES></td></tr>
      </table><br/><br/>";
  ...
  <input style='width: 120px; height: 30px;'  class= button type=button value='KEMBALI' onclick=self.history.back()>
  <span style='float : right;'><input style='width: 180px; height: 30px;' type=submit  class= button value='PROSES ORDER'></span>  </td></tr></table></div>";}}      
  //===========================================================================================================================
...
function antiinjection($data){
  ...
  mysql_query("INSERT INTO orders(nama_kustomer,alamat,telpon,email,tgl_order,jam_order,id_kota) VALUES('$_POST[nama]','$_POST[alamat]','$_POST[telpon]','$_POST[email]','$tgl_skrg','$jam_skrg','$_POST[kota]')");
  ...
  $subjek="Pemesanan Online Ella Boutique";

  // Kirim email dalam format HTML
  $dari = "From: andyprabowo22@yahoo.com \n";
  ...
  mail("andyprabowo22@yahoo.com ",$subjek,$pesan,$dari);
  ...
  //========= Copyright © 2018. Depeloved by: Andy Prabowo  =================================================================  
