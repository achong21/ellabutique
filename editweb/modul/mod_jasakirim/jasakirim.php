...
switch($_GET['act']){
  ...
  default:
    echo "<header><h3>EDIT JASA PENGIRIMAN</h3></header>
           <div class='module_content'><input type=button class='button' value='Tambah Perusahaan Jasa Pengiriman' onclick=\"window.location.href='?module=$module&act=tambahperusahaan';\">";    
