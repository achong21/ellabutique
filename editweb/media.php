...
<body>
	...
	<header id="header">
		<hgroup>
			<h1 class="site_title"><a href=""><img src="images/admin.png" width="284" height="57" /></a></h1>
...
<section id="secondary_bar">
		...
		<div class="breadcrumbs_container">
            ...
            <a href="logout.php" class="current">Keluar</a></article>
		</div>
	...
	<aside id="sidebar" class="column">
	  <h3>MENU UTAMA </h3>
		...
		<footer>
			<hr />
			<p><strong>&copy; 2018 Depeloved by: Andy</strong></p>
